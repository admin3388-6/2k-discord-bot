...
class TicketTypeSelect(ui.Select):
    def __init__(self):
        ...
        super().__init__(placeholder="اختر نوع التذكرة...", options=options, custom_id="main_select")
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(title=f"تذكرة {t_names[t_type]}", description="اكتب مشكلتك هنا وسيتم الرد عليك.", color=0x5865F2)
...
def setup_ticket():
    ...
    if channel:
        embed = discord.Embed(title="🎫 نظام التذاكر", description="يرجى اختيار القسم المناسب لفتح تذكرة.\n\nممنوع فتح تذاكر تافهة.", color=0x2b2d31)
        embed.set_image(url="https://i.ibb.co/9HfG0Lz5/Picsart-25-12-25-15-08-29-765.jpg")
        # استخدام دالة loop لضمان الإرسال من Flask إلى ديسكورد
